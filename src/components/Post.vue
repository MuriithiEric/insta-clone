<template>
  <div class="post-ctn">
    ...
    <div class="post-desc">
      ...
      <div class="likes-count">5,875 likes</div>
      <div class="post-caption">
        <div class="username">ft.muray</div>
        <div class="main-caption">Happy New Year! Swipe for more!</div>
      </div>
      <button class="clear-btn">View all 30 comments</button>
      <div class="post-time">11 HOURS AGO</div>
    </div>
