<template>
  <div class="section page">
    <div class="inner">
      <div class="header">
        <LargeProfileIcon class="ls" />
        <div class="user-info">
          <div class="block-1">
            <div class="username">ft.muray</div>
            <router-link class="edit-btn" to="#"> Edit Profile </router-link>
            <button class="clear-btn settings-btn">
              <svg
                aria-label="Options"
                class="_8-yf5"
                color="#262626"
          ...
          <div class="block-2">
            <div class="user-stat"><b>1</b> post</div>
            <div class="user-stat"><b>193</b> followers</div>
            <div class="user-stat"><b>163</b> following</div>
          </div>
          <div class="block">
            <div class="full-name">M U R I I T H I</div>
            <div class="bio">Romans 12:2 • Christian • SWE</div>
            <a
              target="_blank"
              href="https://murayinnovations.com"
              class="website"
            >
              murayinnovations.com
            </a>
          </div>
        </div>
      </div>
      ...
      <div class="user-content">
        <div class="tab-layout">
          ...
          <router-link
            :class="{
              'clear-btn': true,
              active: $route.name.includes('profile-saved'),
            }"
            to="/profile/saved"
          >
            <svg
          ...
          <router-link
            :class="{
              'clear-btn': true,
              active: $route.name.includes('profile-tagged'),
            }"
            to="/profile/tagged"
          >
            <svg
...
<script>
import LargeProfileIcon from "../components/LargeProfileIcon.vue";
import Highlights from "../components/Highlights.vue";
import ProfilePostGrids from "../components/ProfilePostGrids.vue";

export default {
  name: "Profile",
  components: { LargeProfileIcon, Highlights, ProfilePostGrids },
};
</script>
